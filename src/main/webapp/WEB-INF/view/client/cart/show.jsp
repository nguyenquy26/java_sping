                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center">
                                                    <img src="image/product/${cartItem.product.image}"
                                                        class="img-fluid me-5 rounded-circle"
                                                        style="width: 80px; height: 80px;" alt="productImage">
                                                </div>
                                            </th>
                                            <td>
                                                <p class="mb-0 mt-4">
                                                    <a href="/product/${cartItem.product.id}"
                                                        target="_blank">${cartItem.product.name}</a>
                                                </p>
                                            </td>
                                            <td style="padding-top: 32px;">
                                                <!-- <p class="mb-0 mt-4">${cartItem.product.price}</p> -->
                                                <fmt:formatNumber type="number" value="${cartItem.product.price}" /> vnđ
                                            </td>
                                            <td>
                        ...
                        <div class="row g-4 justify-content-start">
                            <div class="col-sm-8 col-md-7 col-lg-8 col-xl-8">
                                <div class="bg-light rounded">
                                    <div class="p-4">
                                        <h1 class="display-6 mb-4">Thông tin đơn hàng <span class="fw-normal"></span>
                                        </h1>
